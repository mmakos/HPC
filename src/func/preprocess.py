...
# function estimates not detected keypoints in rgbd space
def estimateNotDetectedKeypoints( human, previous=None ):
...
def pointSym( human, x, o, a ):
    return [ ( human[ o ][ 0 ] - human[ x ][ 0 ] ) * a + human[ o ][ 0 ],
             ( human[ o ][ 1 ] - human[ x ][ 1 ] ) * a + human[ o ][ 1 ],
             ( human[ o ][ 2 ] - human[ x ][ 2 ] ) * a + human[ o ][ 2 ],
             1.0 ]
